...
- RS-NEG-001/002/003/005/006/007/008/009/013/014/015 + RS-SEC-005 + RS-SEC-007 + RS-SEC-010 + RS-SEC-011 — active (`check --active`)
...
**Planned (in this catalog, not yet shipped):** RS-NEG-004/010/012, RS-SEC-003/004/006/008, FA-VER-001, DI-003. RS-SEC-003 (cross-resource replay) is considered redundant with RS-NEG-007 + RS-SEC-001.
...
| RS-PR-015 | **x-jp402 invoice** extension (if present) is structurally valid | Opt-in JP-rail check: SKIP unless `x-jp402` advertised; validates `invoice.registrationNumber` (`^T[0-9]{13}$`, 適格請求書) + boolean flags. Community extension (jp402-registry), not core; MINOR so it never gates | jp402-registry | m |
